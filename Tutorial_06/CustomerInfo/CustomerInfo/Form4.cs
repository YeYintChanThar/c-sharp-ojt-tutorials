...
namespace CustomerInfo
{
    public partial class CustomerInfoEdit : Form
    {
        ...
        private void LoadCustomerDetails()
        {
            ...
            {
                conn.Open();
                string query = "SELECT customer_name,customer_id, nrc_number, dob, email, phone_no_1, phone_no_2, address, member_card, gender, photo FROM Customers WHERE id = @id";
        ...
        private void UpdateCustomer(SqlConnection conn)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(query, conn))
            {
                ...
                this.Close();
                UserProfile_Form userProfile_Form = new UserProfile_Form();
